...
{ //  name                      function                 safemd  unlocked
  //  ------------------------  -----------------------  ------  --------
    ...
    { "getcnvalidationstats",   &getcnvalidationstats,   true,   true },
    { "getdbwaitstats",         &getdbwaitstats,         true,   true },
    { "getcollateraloutpointdiagnostics", &getcollateraloutpointdiagnostics, true, true },
    { "getmemorydiagnostics",        &getmemorydiagnostics,        true,   true },
    { "getblockindexv2info",         &getblockindexv2info,         true,   true },
